      ...
      steps{
        ...
        withCredentials([file(credentialsId: 'b73d6ed3-99ff-4e06-b2d8-64eaaf69d1db', variable: 'OCP_AWS'),
            ...
            def RETURNSTATUS = sh(returnStatus: true, script: '''
              ...
              SECONDS=0
              curl -o openshift-qe-workers-infra-workload-commands.sh https://raw.githubusercontent.com/openshift/release/refs/heads/main/ci-operator/step-registry/openshift-qe/workers-infra-workload/openshift-qe-workers-infra-workload-commands.sh
